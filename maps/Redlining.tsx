...
export const TEXT_redlining_accessible_name =
  "The redlining properties of the clicked area";
export const TEXT_redlining_text =
  "This contains the state, city, and name of the clicked redlining area";
...
function Redlining({ state, city, name }: RedliningProps) {
  ...
  return (
    <div
      className="redlining-properties"
